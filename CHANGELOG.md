...
- Added engine-owned page rendering and OCR foundations with paths, tensor shadings, standard and missing-font outlines, calculator colors, JPEG, fax, transparent images, forms, preprocessing, layout analysis, and recognition.
