...
- Added engine-first rendering and OCR across the viewer, thumbnails, print, export, transforms, and OCR, with paths, shadings, font outlines, JPEG, JPEG 2000, JBIG2, fax, transparency, forms, preprocessing, layout analysis, and recognition.
...
- Replaced PDFium and Docnet.Core with engine-owned rendering, improved damaged cross-reference and missing-catalog recovery and JPEG decoding speed, and removed native file-repair and link-extraction fallbacks.
...
- Restored missing page text from graphics-state fonts and missing or corrupt JPEG 2000 image tiles.
