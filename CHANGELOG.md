...
- Added engine-first rendering and OCR across the viewer, thumbnails, print, export, transforms, and OCR, with paths, shadings, font outlines, JPEG, JPEG 2000, JBIG2, fax, transparency, forms, attachment-only encrypted documents, preprocessing, layout analysis, and recognition.
