...
- Improved engine rendering performance and malformed-file compatibility, and removed PDFium file-repair fallbacks from encryption removal and rotation cleanup.
