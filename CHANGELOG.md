...
- Rounded flyout corners in every modern theme.
...
- Restored installable packages after application metadata drifted from compiled resources.

## [1.8.6] - 2026-09-22

1.8.6 restores reliable document viewing across display modes.
