...
{
    [Fact]
    public void ConvertReadsTemplateAndDatasetsFromCombinedXdpStream()
    {
        const string xdp = "<xdp><template><subform name=\"form\" layout=\"position\">"
            + "<field name=\"name\" x=\"10pt\" y=\"20pt\" w=\"70pt\" h=\"15pt\">"
            + "<ui><textEdit/></ui></field></subform></template>"
            + "<datasets><data><form><name>Ada</name></form></data></datasets></xdp>";
        ...
        Assert.Equal("Ada", Assert.Single(
            PdfFormWidgetReader.ReadPage(converted, 0)).Value);
    }
